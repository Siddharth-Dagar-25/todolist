  ...
  return (
    <div>
      ...
      <form onSubmit={submitHandler}>
        <input type='text' className='text-2xl border-zinc-800 border-2 m-8 mt-9 px-4 py-2'
        ...
        <button className='bg-black text-white px-4 py-3 text-2xl m-5'>Add Task</button>
      </form>
      <hr />
